...
export const MAX_CHARS_TOLERANCE_FACTOR = 1.08 // 8% tolerance for max chars
...
export const BATCH_SEGMENT_THRESHOLD = 8 // Number of code segments to batch for embeddings/upserts
export const MAX_BATCH_RETRIES = 6
